...
SELECT
    job_posted_date,
    DATE_TRUNC('year', job_posted_date)::DATE AS truncated_year,
    DATE_TRUNC('quarter', job_posted_date)::DATE AS truncated_quarter,
    DATE_TRUNC('month', job_posted_date)::DATE AS truncated_month,
    DATE_TRUNC('week', job_posted_date)::DATE AS truncated_week,
    DATE_TRUNC('day', job_posted_date)::DATE AS truncated_day,
...
WHERE job_title_short = 'Data Engineer'
    ...
    -- You can use DATE_TRUNC('year', job_posted_date) = '2024-01-01' but Extract is better here
GROUP BY
...
SELECT
    '2024-01-01 00:00:00+00'::TIMESTAMPTZ AT TIME ZONE 'EST';
